             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Rapat Aslab</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Rekap Arsip</li>
                                    <li class="breadcrumb-item active">Rapat Aslab</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url('rekaparsip/tambah_rapat'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data</button></a>
                                <div>
                                    <table id="zero_config" class="table table-striped table-bordered" align="center">
                                        <thead>
                                            <tr>
                                                <th><center>No</center></th>
                                                <th><center>Jenis Rapat</center></th>
                                        ...
                                        <?php
                                            $id = 1;
                                            foreach($rapat as $file_rapat){
                                        ?>
                                            <tr>
                                                <td><center><?php echo $id++; ?></center></td>
                                                <td><?php echo $file_rapat->jenis_rapat; ?></td>
                                                <td><center><?php echo $file_rapat->tanggal_rapat; ?></center></td>
                                                <td><center><a href="<?php echo base_url().'rekaparsip/download_rapat/'.$file_rapat->id_rapat; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-download-alt">Unduh File</a></center></td>
                                            <?php if($this->session->userdata('akses')=='1'): ?>
                                                <td><center><a href="<?php echo base_url().'rekaparsip/hapus_rapat/'.$file_rapat->id_rapat; ?>">Hapus</a></center></td>
                                            <?php endif; ?>
                                            </tr>
                                        <?php
                                        }
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">Lihat Format Upload Rapat</h4>
                                    <a href="<?php echo base_url('rekaparsip/format_rapat'); ?>"><button type="button" class="btn btn-danger btn-sm">Unduh</button></a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">Rapat Asisten</h4>
