             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">LPJ Kegiatan</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Rekap Arsip</li>
                                    <li class="breadcrumb-item active">LPJ Kegiatan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url('rekaparsip/tambah_lpj'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data</button></a>
                                <div>
                                    <table id="zero_config" class="table table-striped table-bordered" align="center">
                                        ...
                                        <?php
                                            $id = 1;
                                            foreach($lpj_kegiatan as $file_lpjkegiatan){
                                        ?>
                                            <tr>
                                                <td><center><?php echo $id++; ?></center></td>
                                                <td><?php echo $file_lpjkegiatan->namakegiatan_lpj; ?></td>
                                                <td><center><?php echo $file_lpjkegiatan->jenis_lpj; ?></center></td>
                                                <td><center><?php echo $file_lpjkegiatan->penanggungjawab_lpj; ?></center></td>
                                                <td><center><?php echo $file_lpjkegiatan->tanggalmulai_kegiatan; ?></center></td>
                                                <td><center><?php echo $file_lpjkegiatan->tanggalselesai_kegiatan; ?></center></td>
                                                <td><center><a href="<?php echo base_url().'rekaparsip/download_lpj/'.$file_lpjkegiatan->id_lpj; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-download-alt">Unduh File</a></center></td>
                                            <?php if($this->session->userdata('akses')=='1'): ?>
                                                <td><center><a href="<?php echo base_url().'rekaparsip/hapus_lpj/'.$file_lpjkegiatan->id_lpj; ?>">Hapus</a></center></td>
                                            <?php endif; ?>
                                            </tr>
                                        <?php
                                        }
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">Lihat Format Upload LPJ</h4>
                                    <a href="<?php echo base_url('rekaparsip/format_lpj'); ?>"><button type="button" class="btn btn-danger btn-sm">Unduh</button></a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">LPJ Kegiatan Asisten</h4>
                                <p>Kegiatan Rapat Asisten Laboratorium dilaksanakan secara rutin pada setiap Seminggu sekali (Rapat Mingguan) & Sebulan sekali (Rapat Bulanan).</p>
                                <img src="">
                            </div>
                        </div>
                    </div>
