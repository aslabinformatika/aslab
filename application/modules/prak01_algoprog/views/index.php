             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ALGORITMA PEMROGRAMAN</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Praktikum</li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('praktikum'); ?>">Algoritma Pemrograman</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h3 class="card-title">DATA PRAKTIKUM <strong>ALGORITMA STRUKTUR DATA</strong></h3></center>
                                <a href="<?php echo base_url('prak01_algoprog/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data</button></a>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><center>Rangkuman</center></th>
                                                <th><center>Tanggal Pengumpulan</center></th>
                                                <th><center>Asisten</center></th>
                                        ...
                                        <?php
                                              $id = 1;
                                            foreach($prak01_algoprog as $data){
                                        ?>
                                            <tr>
                                                <td><center><?php echo $id++; ?></center></td>
                                                <td><center><?php echo $data->nim_praktikum; ?></center></td>
                                                <td><?php echo $data->nama_praktikan; ?></td>
                                                <td><center><?php echo $data->kelompok_praktikum; ?></center></td>
                                                <td><center><?php echo $data->link_rangkuman; ?></center></td>
                                                <td><center><?php echo $data->tanggal_pengumpulan; ?></center></td>
                                                <td><center><?php echo $data->nama_asisten; ?></center></td>
                                                <td><?php echo $data->penerima_laporan; ?></td>
                                            <?php if($this->session->userdata('akses')=='1'): ?>
                                                <td><center><a href="<?php echo base_url().'prak01_algoprog/hapus/'.$data->nim_praktikum; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a></center></td>
                                            <?php endif; ?>
                                            </tr>
                                        <?php
                                        }
