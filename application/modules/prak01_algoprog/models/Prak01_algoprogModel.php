...
class Prak01_algoprogModel extends CI_Model {
  // Fungsi untuk menampilkan semua data
  public function view(){
    return $this->db->get('prak01_algoprog')->result();
  }
  ...
  public function view_by($nim_praktikum){
    ...
    return $this->db->get('prak01_algoprog')->row();
  }
  ...
  public function save(){
    ...
    $this->db->insert('prak01_algoprog', $data); // Untuk mengeksekusi perintah insert data
  }
  ...
  public function edit($nim_praktikum){
    ...
    $this->db->where('nim_praktikum', $nim_praktikum);
    $this->db->update('prak01_algoprog', $data); // Untuk mengeksekusi perintah update data
  }
  
  // Fungsi untuk melakukan menghapus data berdasarkan id_user
  public function delete($nim_praktikum){
    $this->db->where('nim_praktikum', $nim_praktikum);
    $this->db->delete('prak01_algoprog'); // Untuk mengeksekusi perintah delete data
  }
}