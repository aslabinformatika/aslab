                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('praktikum'); ?>">Algoritma Struktur Data</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('prak02_algostruk/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data</button></a>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <?php
                                              $id = 1;
                                            foreach($prak02_algostruk as $data){
                                        ?>
                                            <tr>
                                            ...
                                            <?php if($this->session->userdata('akses')=='1'): ?>
                                                <td><center><a href="<?php echo base_url().'prak02_algostruk/hapus/'.$data->nim_praktikum; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a></center></td>
                                            <?php endif; ?>
                                            </tr>
                                        <?php
                                        }
