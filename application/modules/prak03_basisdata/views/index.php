             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">BASIS DATA</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Praktikum</li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('praktikum'); ?>">Basis Data</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h3 class="card-title">DATA PRAKTIKUM <strong>BASIS DATA</strong></h3></center>
                                <a href="<?php echo base_url('prak03_basisdata/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data</button></a>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <?php
                                              $id = 1;
                                            foreach($prak03_basisdata as $data){
                                        ?>
                                            <tr>
                                            ...
                                            <?php if($this->session->userdata('akses')=='1'): ?>
                                                <td><center><a href="<?php echo base_url().'prak03_basisdata/hapus/'.$data->nim_praktikum; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a></center></td>
                                            <?php endif; ?>
                                            </tr>
                                        <?php
                                        }
