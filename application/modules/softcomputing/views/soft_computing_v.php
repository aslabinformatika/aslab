            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">SOFT COMPUTING</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Soft Computing</li>
                                    <li class="breadcrumb-item active">Data Lab Soft Computing</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">UPDATE DATA BARANG <strong>SOFT COMPUTING</strong></h3>
                                </center>
                                <a href="<?php echo base_url('softcomputing/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data Barang</button></a>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $id = 1;
                                            foreach ($lab_softcomputing as $data) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_softcomputing; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_softcomputing; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_softcomputing; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_softcomputing; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_softcomputing; ?></center>
                                                    </td>
