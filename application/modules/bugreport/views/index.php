                ...
                <div class="row">
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <h3>Lapor Bug Program</h3>
                                    <form method="POST" action="<?php echo base_url('bugreport/tambah'); ?>" enctype="multipart/form-data">
                                        <!-- FORM JENIS MULAI -->
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" value="<?php echo $this->session->userdata("ses_nama"); ?>">
                                            <span class="text-danger"><?php echo form_error('nama');?></span>
                                        </div>
                                        <!-- FORM JENIS BUYAR -->
                                        <!-- FORM TANGGAL MULAI -->
                                        <div class="form-group">
                                            <label for="deskripsi_bug">
                                            Deskripsi Bug
                                                <span class="text-danger">*</span>
                                            </label>
                                            <textarea id="deskripsi_bug" class="form-control" name="deskripsi_bug" rows="5" placeholder="Masukkan Deskripsi Bug Anda Disini"></textarea>
                                        </div>
                                        <!-- FORM TANGGAL BUYAR -->
                                        <!-- FORM FILE MULAI -->
                                        <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">Record Laporan Bug Program</h4>
                                    <div>
                                    <table id="zero_config" class="table table-striped table-bordered" align="center">
                                        <thead>
                                            <tr>
                                                <th><center>Nama</center></th>
                                                <th><center>Deksripsi</center></th>
                                        ...
                                        <tbody>
                                        <?php
                                            foreach($bugreport as $file){
                                        ?>
                                            <tr>
                                                <td><?php echo $file->nama; ?></td>
                                                <td><center><?php echo $file->deskripsi_bug; ?></center></td>
