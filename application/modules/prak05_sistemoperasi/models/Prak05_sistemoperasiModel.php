...
class Prak05_sistemoperasiModel extends CI_Model {
  // Fungsi untuk menampilkan semua data
  public function view(){
    return $this->db->get('prak05_sistemoperasi')->result();
  }
  ...
  public function view_by($nim_praktikum){
    ...
    return $this->db->get('prak05_sistemoperasi')->row();
  }
  ...
  public function save(){
    ...
    $this->db->insert('prak05_sistemoperasi', $data); // Untuk mengeksekusi perintah insert data
  }
  ...
  public function edit($nim_praktikum){
    ...
    $this->db->where('nim_praktikum', $nim_praktikum);
    $this->db->update('prak05_sistemoperasi', $data); // Untuk mengeksekusi perintah update data
  }
  
  // Fungsi untuk melakukan menghapus data berdasarkan id_user
  public function delete($nim_praktikum){
    $this->db->where('nim_praktikum', $nim_praktikum);
    $this->db->delete('prak05_sistemoperasi'); // Untuk mengeksekusi perintah delete data
  }
}