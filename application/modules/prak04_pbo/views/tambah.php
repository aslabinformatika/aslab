                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">PBO</li>
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('prak04_pbo/tambah'); ?>">Tambah Data</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <center><h3 class="card-title">TAMBAH DATA PRAKTIKUM <strong>PBO</strong></h3></center>
                                    <div style="color: red;"><?php echo validation_errors(); ?></div>
                                    <?php echo form_open("prak04_pbo/tambah_data", array('enctype'=>'multipart/form-data')); ?>
                                    <?php
