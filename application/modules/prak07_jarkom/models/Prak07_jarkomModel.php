...
class Prak07_jarkomModel extends CI_Model {
  // Fungsi untuk menampilkan semua data
  public function view(){
    return $this->db->get('prak07_jarkom')->result();
  }
  ...
  public function view_by($nim_praktikum){
    ...
    return $this->db->get('prak07_jarkom')->row();
  }
  ...
  public function save(){
    ...
    $this->db->insert('prak07_jarkom', $data); // Untuk mengeksekusi perintah insert data
  }
  ...
  public function edit($nim_praktikum){
    ...
    $this->db->where('nim_praktikum', $nim_praktikum);
    $this->db->update('prak07_jarkom', $data); // Untuk mengeksekusi perintah update data
  }
  
  // Fungsi untuk melakukan menghapus data berdasarkan id_user
  public function delete($nim_praktikum){
    $this->db->where('nim_praktikum', $nim_praktikum);
    $this->db->delete('prak07_jarkom'); // Untuk mengeksekusi perintah delete data
  }
}