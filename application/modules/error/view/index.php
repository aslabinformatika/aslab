    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">KONTAK LABORATORIUM INFORMATIKA UNTUK LEBIH LANJUT</p>
                <a href="<?php echo base_url('dashboard') ?>" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Ke Beranda</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
